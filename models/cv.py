...
class CvModel(db.Model):
    ...
    application = db.relationship("ApplicationModel", back_populates="cv", lazy="dynamic", cascade="all, delete")
    ...
    def to_dict(self):
        return {
            ...
            "date_posted_cv": self.date_posted_cv.isoformat() if self.date_posted_cv else None,
